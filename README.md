...
> 🚀 精选 AI 技能合集与优质资源汇总，涵盖语言学习、知识管理、财富管理、方法论、AI 开发、设计创意等多个领域。持续更新，欢迎关注！
...
#### CDA (Causal Dynamics Architecture)
...
> 欢迎推荐优质仓库！提交 Issue 或 PR 即可。

| 仓库名称 | 作者 | 链接 | 描述 |
|---------|------|------|------|
| [web-to-FIM](https://github.com/EdwardWason/web-to-FIM) | EdwardWason | https://github.com/EdwardWason/web-to-FIM | Web 转 FIM 工具集 |
| [ai-skills-collection](https://github.com/EdwardWason/ai-skills-collection) | EdwardWason | https://github.com/EdwardWason/ai-skills-collection | AI 技能合集（已迁移至此） |
...
1. **AI 技能合集**：按功能分类整理的 25 个 AI 技能，每个技能包含简介、使用案例和仓库链接
2. **优质教程**：收集整理的优质技术教程
3. **推荐仓库**：值得关注的 GitHub 仓库汇总

### 贡献指南

欢迎您持续维护和扩展这个仓库！以下是贡献方式：
...
- 所有技能信息均来自 SkillHub 和 ClawHub 平台
- 技能分类基于实际功能和应用场景
- 如需更新技能信息，请按照现有格式进行编辑
- 推荐的教程和仓库请确保质量和相关性
...
本仓库内容仅供学习和展示使用，各技能和资源的许可证请参考其原始来源。
